...
public static class SlidingDoorPrefabCreator
{
    ...
    public static void CreateSlidingDoorPrefab()
    {
        ...
        controller.GetType().GetField("slidingPanel", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)
            .SetValue(controller, rightPanel.transform);
        controller.GetType().GetField("slidesLeft", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)
            .SetValue(controller, true);
        controller.GetType().GetField("slideDistance", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)
            .SetValue(controller, 0.91f);
